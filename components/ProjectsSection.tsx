...
import { FILE_RECORDS, FileRecord } from "@/lib/constants";
    ...
    <section id="projects" className="py-20 px-6 relative overflow-hidden bg-black">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-gray-500 font-mono text-sm">// Loading project archives...</p>
        </motion.div>

        {/* File Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 auto-rows-fr">
          {FILE_RECORDS.map((file, idx) => (
...
function FileCard({ file, delay }: { file: FileRecord; delay: number }) {
  ...
  return (
    ...
    >
      {/* File Card */}
      <div
        className="relative rounded-lg overflow-hidden bg-black/90 border-2 transition-all duration-300 hover:scale-[1.01] backdrop-blur-xl shadow-lg h-full flex flex-col"
        style={{
